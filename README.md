...
Additional notes about the gap between PRAM pseudocode and OpenMP synchronization are available in [src/pointer_jumping/README.md](src/pointer_jumping/README.md).
